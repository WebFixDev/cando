  ...
  return (
    <div className="relative md:h-[38rem] h-[32rem]  flex justify-center items-center text-white">
      ...
      <div className="relative z-10 text-center mt-20 px-4">
        ...
        <p className="text-center text-[18px] sm:text-[20px] md:text-[23px] font-normal text-heading mt-4 leading-relaxed">
          Through passion and commitment, we are always aiming{" "}
